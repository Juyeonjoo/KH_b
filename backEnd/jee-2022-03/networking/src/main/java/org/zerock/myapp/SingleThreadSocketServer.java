...
//		ServerSocket serverSocket = new ServerSocket(listenPort); //Default backlog=50;
		ServerSocket serverSocket = new ServerSocket(listenPort, backlog); //custom backlog =100;
		...
		while(true) { //무한루프
			...
			// (*주의 : 연결 요청이 들어오기 전까지 아래의 accept() 메소드는 실행을 멈춤(blocking)

...
WHERE
 hire_date > to_date('07/12/31', 'RR/MM/DD'); --<-SQL developer 형식
 --hire_date > to_date('31-DEC-07','DD-MONTH-RR');
...
-- WHERE 
    -- hire_date BETWEEN '07/01/01' AND '08/12/31';    --sqldeveloper       
--    hire_date BETWEEN'01-JAN-07' AND '31-DEC-12'      --vscode
WHERE 
    hire_date 

...
ALTER TABLE dept
DISABLE CONSTRAINT pk_dept; --primary key 이름 -- xx
-- ORA-02297: cannot disable constraint (SCOTT.PK_DEPT) - dependencies exist

ALTER TABLE dept
DISABLE CONSTRAINT pk_dept CASCADE; --ok
...
-- XX, enable에서는 CASCADE 옵션 사용 불가
-- CASCADE 옵션은 제약 조건의 비활성화시에만 사용하는 것

ALTER TABLE dept
ENABLE CONSTRAINT pk_dept; -- 부모 pk만 활성됨

ALTER TABLe emp
ENABLE CONSTRAINT FK_DEPTNO;    --자식 FK 제약 조건 활성화 수행

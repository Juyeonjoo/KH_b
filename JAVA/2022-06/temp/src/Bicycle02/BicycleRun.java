 ...
 *   4. 안장의 높이를 조절 ( 사람의 키 입력 ) => KumhoSeat에 메소드 존재
 *   5. 처음 출발을 기어 3단, 페달 60회로 출발 => KumhoPedal에 분당 회전수 & 속도 메소드 존재 => 호출하여 입력값에 맞게 출력
 ...
 *   11. 맨 마지막인 30km에 도달하면, 브레이크를 작동 시키고  stop하고 30km를 완주하였다고 하고 끝낸다.    
 */
